<?php require('includes/db_connect.php');
    ...
    while ($stmt->fetch()) {
        ...
        $course = array (
            ...
            '<button onclick="addCourse($(this))" id="wish' . $id . '" courseId="' . $id . '" class="addButton btn btn-primary">Add to wishlist</button><br /><a target="_blank" href="' . $course_link . '">' . $title . '</a>',
