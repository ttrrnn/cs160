<?php require('includes/db_connect.php');
    ...
    while ($stmt->fetch()) {
        ...
        $course = array (
            ...
            '<button onclick="rateCourse($(this))" type="button" class="btn btn-primary" data-toggle="modal" data-target="#rate-popup" id="' . $id . '">Rate</button><div class="raty" value="' . $rating . '"><span>' . $rating . '</span></div>', 
            $category,
            $start_date,
            $course_length,
            $professor_name,
